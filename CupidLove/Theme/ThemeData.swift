...
public struct ThemeData: Codable {
    ...
    public var paleGray: String
    public var lightPink: String
    public var almostWhite: String
    ...
    public init(dict: [String: Any]) {
        ...
        pink = dict["pink"] as! String
        blue = dict["blue"] as! String
        lightGray = dict["lightGray"] as! String
        
        paleGray = dict["paleGray"] as! String
        lightPink = dict["lightPink"] as! String
        almostWhite = dict["almostWhite"] as! String
