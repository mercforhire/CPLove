//
//  MyLikedUsersViewController.swift
//  CupidLove
//
...
class MyLikedUsersViewController: BaseViewController {
    private let itemInfo = IndicatorInfo(title: "Liked Users")
    ...
    private func fetchData(complete: ((Bool) -> Void)? = nil) {
        ...
        api.getMyLikedUser(userId: user.identifier) { [weak self] result in
...
extension MyLikedUsersViewController: IndicatorInfoProvider {
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return itemInfo
    }
}

extension MyLikedUsersViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
